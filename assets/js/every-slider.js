...
//     function styleForDistance(d, isFlipped) {
//         var flipTransform = isFlipped ? " " : "";
//         if (isMobile()) {
//             var base =
...
//                 return (
//                     base +
//                     "transform: translateY(0) scale(1)" + flipTransform + "; opacity: 1;" +
...
//             return (
//                 base +
//                 "transform: translateY(0) scale(0.94)" + flipTransform + "; opacity: 0.65;" +
//                 inactiveShadow
//             );
//         }
...
//         if (ad === -3) return base + "transform: translateY(28px) rotate(-6deg)" + flipTransform + ";" + shadow;
//         if (ad === -2) return base + "transform: translateY(8px) rotate(-4.5deg)" + flipTransform + ";" + shadow;
//         if (ad === -1) return base + "transform: translateY(-5px) rotate(-2.5deg)" + flipTransform + ";" + shadow;
//         if (ad === 1) return base + "transform: translateY(-9px) rotate(2.5deg)" + flipTransform + ";" + shadow;
//         if (ad === 2) return base + "transform: translateY(2px) rotate(3.5deg)" + flipTransform + ";" + shadow;
//         if (ad === 3) return base + "transform: translateY(16px) rotate(4deg)" + flipTransform + ";" + shadow;
//         // return (
//         //     base +
...
//         // );
//         if (isHovering && ad === 0) {
//             return base + "transform: translateY(-8px) rotate(0deg) scale(1.03)" + flipTransform + "; " + shadow;
//         }

//         return (
//             base +
//             "transform: translateY(-8px) rotate(0deg) scale(1.03)" + flipTransform + ";" +
//             activeShadow +
//             "background: linear-gradient(180deg, #5a54bf 0%, #2c2973 100%);" +
//             "border-color: #5b54c8;"
//         );
...
//             var isFlipped = el.classList.contains("is-flipped");
//             el.setAttribute("style", styleForDistance(d, isFlipped));
...
//             if (d === 0) {
//                 if (isHovering) {
//                     if (h3) h3.setAttribute("style", "color: var(--primary); transition: color 0.45s ease;");
//                     if (p) p.setAttribute("style", "color: var(--primary); transition: color 0.45s ease;");
//                 } else {
